"""
chit.loop.runtime_store
------------------------------------------------------------------------------
Runtime storage abstraction for runner-facing state operations.

This protocol is intentionally shaped around the operations Chit runners
...
from chit.core.task import LedgerStats, Task, TaskResult, TaskStatus
...
class RuntimeStore(Protocol):
    ...
    Backends implementing this protocol can power ChitRunner without
