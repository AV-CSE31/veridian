...
Python predicate with the versioned :class:`~chit.assurance.VerifierManifestV1`
...
CHECK_IDENTITY_SCHEMA_ID = "chit.gate.check-identity.v1"
CHECK_IO_SCHEMA_ID = "chit.gate.check-io.v1"
