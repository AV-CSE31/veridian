...
from chit.assurance import Signer, sha256_digest
from chit.assurance._canonical import require_string
from chit.assurance._model import parse_utc_second
from chit.effects import DispatchRequest, DispatchResult, EffectReceiptType
...
class SyntheticRtgsAdapter:
    ...
    adapter_id = "chit.synthetic-rtgs.v1"
