...
RECEIPT_SCHEMA_ID = "chit.receipt-statement.v1"
RECEIPT_PAYLOAD_TYPE = "application/vnd.chit.receipt-statement.v1+json"
DSSE_ENVELOPE_SCHEMA_ID = "chit.dsse-envelope.v1"
