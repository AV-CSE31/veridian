...
from solution import build_auditable_pipeline
...
class TestCompliantChain:
    ...
    def test_report_total_tasks(self) -> None:
        report = ComplianceReportGenerator(proof_chain=build_auditable_pipeline()).generate(ComplianceStandard.EU_AI_ACT)
