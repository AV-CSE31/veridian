...
chit.loop.runner
---------------------------------------------------------------
ChitRunner --- the main synchronous task execution loop.
...
from chit.providers.base import LLMProvider
from chit.verify.base import VerifierRegistry

__all__ = ["ChitRunner", "RunSummary"]
...
@dataclass
class RunSummary:
    """Final report returned by ChitRunner.run()."""
...
class ChitRunner:
    ...
    def __init__(
        ...
        config: ChitConfig | None = None,
        hooks: HookRegistry | None = None,
        verifier_registry: VerifierRegistry | None = None,
    ) -> None:
        self.ledger = ledger
        self.provider = provider
        self.config = config or ChitConfig()
        self.hooks = hooks or HookRegistry()
        if verifier_registry is None:
            from chit.verify.base import registry as _builtin_registry  # noqa: PLC0415
    ...
    def _build_confidence(
        ...
        try:
            from chit.verify.builtin.confidence import ConfidenceScore  # noqa: PLC0415
