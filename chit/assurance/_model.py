...
ACTION_SCHEMA_ID = "chit.action-semantics.v1"
COMPLETION_SCHEMA_ID = "chit.completion-semantics.v1"
AUTHORIZATION_SCHEMA_ID = "chit.authorization-envelope.v1"
TRANSPORT_SCHEMA_ID = "chit.transport-binding.v1"
