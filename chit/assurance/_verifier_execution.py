...
VERIFIER_MANIFEST_SCHEMA_ID = "chit.verifier-manifest.v1"
ISOLATED_REQUEST_SCHEMA_ID = "chit.isolated-verification-request.v1"
ISOLATED_RESULT_SCHEMA_ID = "chit.isolated-verification-result.v1"
