...
from chit.assurance import encode_profile_v1, sha256_digest
from chit.assurance._canonical import require_digest, require_string
    ...
    def redeem(
        ...
        *,
        ...
        redemption_digest = sha256_digest(
            encode_profile_v1(
                {
                    "schema_id": "chit.permit-redemption.v1",
