...
through Chit's stable profile instead of depending on Pydantic AI's Python
...
PYDANTIC_AI_DEFERRED_TOOL_PROFILE_V1 = "chit.pydantic-ai.deferred-tool.v1"
...
class PydanticAIDeferredToolAdapter(StrictActionAdapter):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            specs,
            adapter_id="chit.pydantic-ai.deferred-tool",
