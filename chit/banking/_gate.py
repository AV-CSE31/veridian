...
BANK_SNAPSHOT_PAYLOAD_TYPE = "application/vnd.chit.bank-control-snapshot.v1+json"
BANK_CONTRACT_BYTES = encode_profile_v1(
    {
        "schema_id": "chit.bank-payment-contract.v1",
        "contract_id": "industrial-rtgs-assurance",
        "clause_algebra": "chit.decision.v1",
    }
)
...
BANK_VERIFIER_MANIFEST_DIGEST = sha256_digest(
    encode_profile_v1(
        {
            "schema_id": "chit.verifier-manifest-lite.v1",
