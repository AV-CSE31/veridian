...
def run_demo() -> None:
    ...
    print(f"  Amazon's fix: require senior sign-offs.")
    print(f"  Veridian's fix: deterministic two-gate verification.")
    print(f"  {'=' * 71}")
