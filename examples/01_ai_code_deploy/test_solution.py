...
verify_deploy = _solution.verify_deploy

# Real incident patterns parametrized
BLOCKED_CASES = [
    (
        "kiro_os_system",
        "import os\nos.system('kubectl apply -f x.yaml --force')",
        "Amazon Kiro: os.system deploy",
    ),
...
class TestBlocksAmazonOutagePatterns:
    ...
    def test_gate2_blocks_missing_fields(
        self, name: str, code: str, output: dict[str, object], desc: str
    ) -> None:
