...
from chit.providers.litellm_provider import CBState, CircuitBreaker
...
class TestRetryableErrors:
    def test_rate_limit_is_retryable(self):
        from chit.providers.litellm_provider import _is_retryable
...
class TestMockProvider:
    ...
    def test_script_harness_result(self):
        ...
        mock = MockProvider()
        mock.script_chit_result({"status": "compliant"}, summary="ok")
