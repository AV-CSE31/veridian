...
class EUAIActCompliancePack:
    ...
    def add_mapping(self, mapping: ArticleMapping) -> None:
        """Register or replace a mapping for an article."""
        self._mappings[mapping.article] = mapping
        log.debug("compliance.add_mapping article=%s", mapping.article.value)
