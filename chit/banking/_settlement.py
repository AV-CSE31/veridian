...
from chit.assurance._canonical import (
    require_digest,
...
BANK_SETTLEMENT_SCHEMA_ID = "chit.bank-settlement-receipt.v1"
BANK_SETTLEMENT_PAYLOAD_TYPE = "application/vnd.chit.bank-settlement-receipt.v1+json"
