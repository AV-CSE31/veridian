...
Usage::
    ...
    mock.script([
        LLMResponse(content='<chit:result>{"summary":"done","structured":{"field":"val"}}</chit:result>'),
...
class MockProvider(LLMProvider):
    ...
    def script_chit_result(
        self,
        structured: dict[str, Any],
        summary: str = "done",
    ) -> MockProvider:
        """Convenience: script a valid chit:result block."""
        import json
