...
def _build_default_graph() -> RegulatoryGraph:
    ...
    g.add_edge(RegEdge(source="nist_ai_rmf", target="nist_ai_rmf_govern", edge_type=EdgeType.REQUIRES))
    g.add_edge(RegEdge(source="nist_ai_rmf", target="nist_ai_rmf_map", edge_type=EdgeType.REQUIRES))
    g.add_edge(RegEdge(source="nist_ai_rmf_govern", target="llm_judge", edge_type=EdgeType.IMPLEMENTS))
