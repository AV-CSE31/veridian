...
class TestToolSafetyErrorMessages:
    ...
    def test_error_message_within_budget(self, verifier: ToolSafetyVerifier, task: Task) -> None:
    ...
    def test_error_names_violation(self, verifier: ToolSafetyVerifier, task: Task) -> None:
