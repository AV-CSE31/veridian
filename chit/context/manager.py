...
BLOCK ORDER IS A FROZEN CONTRACT. Do NOT reorder.
  ...
  6. [OUTPUT FMT]   chit:result XML format
"""
...
_FALLBACK_SYSTEM = (
    "You are a Chit AI agent. Complete the assigned task precisely and output "
...
class ContextManager:
    ...
    def _build_environment_block(self, context_files: list[str]) -> str:
        ...
        live within the configured ``CHIT_DATA_DIR`` (or the current
        ...
        context can set ``CHIT_CONTEXT_ALLOW_OUTSIDE_DATA_DIR=1``.
        """
        import os  # noqa: PLC0415

        from chit.core.config import default_data_dir  # noqa: PLC0415

        allow_outside = os.getenv("CHIT_CONTEXT_ALLOW_OUTSIDE_DATA_DIR", "").strip() == "1"
